				...
				if (!fs.existsSync(fileName)) {
					...
					fs.stat(fileName, function(error, stats) {
						...
						//		self.rawFileContent=data;
								...
								var possibleFileFieldList=self.headerList=self.lineList[0].split('\t');
								if (qtools.toType(self.definition.fieldList)=='array' && qtools.isNotEmpty(self.definition.fieldList)){
								...
								if (self.skipFirstLine){qtools.message('found self.skipFirstLine');}
