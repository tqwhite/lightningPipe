		...
		self.profileData = {
			...
			dataSource: {
				...
				schemaSourceNameMapping: {
					...
					homeroom: 'NONE',
					assignStudent: 'NONE',
					assignTeacher: 'Section_Staff_File',
					student: 'Student_Base_File',
					term: 'NONE',
					gradeLevel: 'NONE',
					school: 'NONE',
					schoolSetCurrentTerm: 'NONE'
				}
			},
