...
var moduleFunction = function(args) {
	...
	var getBadSegments = function(newQuery) {

		for (var i = 0, len = newQuery.length; i < len; i++) {
			var element = newQuery[i].name;

			if (self.validUriSegmentNames.indexOf(element) == -1) {
	...
	this.validQuery = function() {

		var badSegments = getBadSegments(args.queryInfo);
		if (badSegments) {
			self.emit('gotBadData', {
				errno: -1,
				message: "Bad segment(s) in URI",
				evidence: badSegments
			});
			return false;
		}
		return true;
