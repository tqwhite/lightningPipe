...
var processForStudents = function(sqlizer) {
	...
	var SE1 = qtools.clone(tables.Student_Enrollment),
	...
	sqlizer.summarize('maxEnrollDate', 'SE1.StateStudentNumber', function(recordSet) {
		var maxDate;
...
if (element.SE1.StateStudentNumber == '0213002019014') {
console.log('maxDate='+maxDate+'\n');
	console.log('summarize SE1:' + element.SE1.StateStudentNumber + '/' + element.SE1.EntryDate + ' SE2:' + element.SE2.StateStudentNumber + '/' + element.SE2.EntryDate + '\n');
}
	...
	// 	for (var i = 0, len = sqlizer.workingTable.length; i < len; i++) {
	// 		if (sqlizer.workingTable[i].SE1.StateStudentNumber == '0213002019014') {
	// 
	// 			console.log('i=' + i + '\n');
	// 			qtools.dump({
	// 				'\n\n===== sqlizer.workingTable[i] =====\n': sqlizer.workingTable[i]
	// 			});
	// 		}
	//	}

qtools.die(qtools.errorObject("'die'", 'die'));
	...
	sqlizer.mapColumns({
		...
		"Student_Base.SchoolNextYear": function() {
			return "";
		},
