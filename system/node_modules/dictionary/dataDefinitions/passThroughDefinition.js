...
var Student_Enrolled_File_FieldList = [
"Student_Base.DistrictCode",
"Student_Base.DistrictType",
"Student_Base.SchoolCode",
"Student_Base.SchoolYearBegin",
"Student_Base.Expr1",
"Student_Enrollment.Next Year School",
"Student_Base.StudentUniqueIdentifier",
"Student_Base.Gender",
"Student_Base.StateStudentNumber",
"Student_Enrollment.GradeLevel",
"Student_Base.Graduation Year",
"Student_Base.Student Status",
"Student_Base.LastName",
"Student_Base.FirstName",
"Student_Base.MiddleName",
"Address_Contact.Address1",
"Address_Contact.Address2",
"Address_Contact.City",
"Address_Contact.StateCode",
"Address_Contact.ZipCode",
"Address_Contact.ContactPhone1",
"Address_Contact.ContactPhone2",
"Address_Contact.ContactPhone3",
"Student_Enrollment.StudentResidentDistrictCode",
"Student_Enrollment.StudentResidentDIstrictType",
"Student_Base.HRTeacher",
"Student_Base.CounselorID",
"Student_Base.SSN",
"Student_Base.EthnicityCode",
"Student_Enrollment.HomePrimaryLanguage",
"Student_Base.PrimaryLanguage",
"Student_Enrollment.StateAidCategory",
"Student_Base.LastSchoolAttended",
"Student_Base.Concurrent Enrollment",
"Student_Base.BirthDate",
"Student_Base.Self Guardian Flag",
"Student_Enrollment.WardofStateFlag",
"Student_Enrollment.SpecEd Flag",
"Student_Enrollment.SpecialEducationEvaluationStatus",
"Student_Enrollment.SpecialEdInstructionalSetting",
"Student_Enrollment.PrimaryDisability",
"Student_Enrollment.[504 Flag]",
"Student_Enrollment.StudentTitle1Indicator",
"Student_Enrollment.LEP",
"Student_Enrollment.EconomicIndicator",
"Student_Enrollment.Gifted&TalentedParticipation",
"Student_Enrollment.MigrantIndicator",
"Student_Enrollment.Promotion Status",
"Student_Base.TYAbsencesEx",
"Student_Base.TYAbsencesUn",
"Student_Base.TYISS",
"Student_Base.TYOSS",
"Student_Base.TLYPromotionStatus",
"Student_Base.LYAbsencesEx",
"Student_Base.LYAbsencesUn",
"Student_Base.LYISS",
"Student_Base.LYOSS",
"Student_Base.GPA",
"Student_Base.Credits",
"Student_Enrollment.Program of Study"];
var Schedule_File_FieldList = [
	"Section_Student.DistrictCode",
...
var Guardian_File_FieldList = [
"Address_Contact.DistrictCode",
"Address_Contact.DistrictType",
"Address_Contact.StudentUniqueIdentifier",
"Address_Contact.SchoolCode",
"Address_Contact.GuardianType",
"Address_Contact.Guardseq",
"Address_Contact.ContactLastName",
"Address_Contact.ContactFirstName",
"Address_Contact.ContactMiddleName",
"Address_Contact.ContactFullName",
"Address_Contact.Address1",
"Address_Contact.Address2",
"Address_Contact.City",
"Address_Contact.StateCode",
...
"Address_Contact.ContactPhone2",
"Address_Contact.ContactPhone3",
"Address_Contact.Relationship",
"Address_Contact.LegalGuard",
"Address_Contact.OtherGuardian",
"Address_Contact.ParentStatus",
"Address_Contact.EmailAddress"];
...
// var tmp=qtools.getByProperty(sqlizer.workingTable, 'Student_Base.StudentUniqueIdentifier', '468120030');
// qtools.die(qtools.errorObject("tmp", tmp));
	...
	sqlizer.mapColumns({
		...
		"Student_Base.xxx": function(record) {
			var value = record.Student_Base.LocalStudentNumber
			return value;
		},
...
var maxDate=record.maxEntryDate[0].EntryDate, //by law, there is only one maxEntryDate element
	entryDate=element.EntryDate;
		...
		if (entryDate && (entryDate == maxDate)){
			...
			if (element['Enrollment Status'] && element['Enrollment Status'].toLowerCase() == "a"){
...
// if (record.Student_Base.StudentUniqueIdentifier=='106727'){
// 
// qtools.dump({'===== record =====':record});
// console.log('gotMaxEnrollmentData='+gotMaxEnrollmentData+'\n');
// console.log('emptyContacts='+emptyContacts+'\n');
