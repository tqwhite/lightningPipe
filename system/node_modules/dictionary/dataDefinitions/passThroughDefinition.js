...
// var clone=qtools.clone(sqlizer.workingTable),
// 	subset=[];
// 	
// for (var i = 0, len = clone.length; i < len; i++) {
// 	var element = clone[i];
// 	if (element.Address_Contact.Address1 == '101 Lake Henry Ave S') {
// 		subset.push(element);
// 	}
// }
// 
...
// 	'\n\n===== subset =====\n': subset
// });
// var tmpp = JSON.stringify(subset);
// var fs = require('fs');
// fs.writeFileSync('/Users/tqwhite/tmp/subset', tmpp);
// 
// 
	...
	var bethSelector = function(record) {
		...
		var selected = 
		record.Student_Enrollment.EntryDate == record.maxEntryDate.EntryDate
		&&
		(
		(
