...
var moduleFunction = function(args) {
	...
	this.getComponentSchemaInfo = function(schemaName) {
		...
		if (global.localEnvironment.testServer) {
			for (var i = 0, len = schemaList.length; i < len; i++) {
				...
				if (!self.definitions[element]) {
					qtools.message("Invalid component schema name: " + element + " does not exist");
				}
			}
		}
	...
	this.getDefinition = function() {
		...
		var definitionName = self.definitionName;
	...
	this.setDefinitionName = function(definitionName) {
		self.definitionName = definitionName;
	}

	this.flatSpecs = function() {
	
		if (self.definitions[self.definitionName]){
		var fieldList=self.definitions[self.definitionName].fieldList;
		return {
			fieldList: fieldList,
