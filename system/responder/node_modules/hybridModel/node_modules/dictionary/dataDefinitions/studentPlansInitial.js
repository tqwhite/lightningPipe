...
var Section_Student_FieldList = ["districtCode", "districtType", "schoolCode", "studentUniqueIdentifier", "stateStudentIdentifier", "localStudentIdentifier", "schoolYearBegin", "schoolYearEnd", "sectionNumber", "courseNumber", "gradeLevelLevel", "entryDate", "withdrawalDate", "entryType", "withdrawalType"];
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Address_Contact where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Course where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "User_Base"
					},
					mssql: {
						query: "select * from User_Base where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "Lookups"
					},
					mssql: {
						query: "select * from Lookups where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Section where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Section_Staff where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Section_Student where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "Student_Attendance"
					},
					mssql: {
						query: "select * from Student_Attendance where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Student_Base where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "Student_Discipline"
					},
					mssql: {
						query: "select * from Student_Discipline where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					...
					mssql: {
						query: "select * from Student_Enrollment where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "Student_gpa"
					},
					mssql: {
						query: "select * from Student_gpa where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
		...
		componentSchemaList: [
			{
				...
				accessInfo: {
					file: {
						fileBaseName: "Student_gradeLevels"
					},
					mssql: {
						query: "select * from Student_gradeLevels where ext.SectionStudent.schoolCode='<!schoolCode!>';"
					}
				}
			}
		],
