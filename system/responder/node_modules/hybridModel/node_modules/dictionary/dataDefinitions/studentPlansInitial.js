...
var processForSchedule = require(__dirname + '/lib/studentPlansInitial.processForGuardians.js');
var processForGuardians = require(__dirname + '/lib/studentPlansInitial.processForSchedule.js');
...
module.exports = {
	...
	"Student_Enrolled": {
		...
		"sql":{
			"mssql":[
				{schemaName:'Student_Base', query:"SELECT  ext.StudentBase.* FROM   (ext.StudentBase         LEFT JOIN ext.AddressContact                ON ext.StudentBase.studentuniqueidentifier =                   ext.AddressContact.studentuniqueidentifier)        LEFT JOIN ext.StudentEnrollment               ON ext.StudentBase.studentuniqueidentifier =                  ext.StudentEnrollment.studentuniqueidentifier WHERE  (           (              ext.StudentEnrollment.entrydate IN (                SELECT Max(entrydate)                FROM ext.StudentEnrollment SE                WHERE ext.StudentEnrollment.studentuniqueidentifier = SE.studentuniqueidentifier              )            )          AND ( ( ext.AddressContact.addresstypecode ) = 'primary1'                 OR ( ext.AddressContact.addresstypecode ) IS NULL )          AND ( ( ext.StudentEnrollment.enrollmentstatus ) = 'a' ) )          and ext.StudentBase.schoolCode='010';"},
				{schemaName:'Address_Contact', query:"SELECT  ext.AddressContact.* FROM   (ext.StudentBase         LEFT JOIN ext.AddressContact                ON ext.StudentBase.studentuniqueidentifier =                   ext.AddressContact.studentuniqueidentifier)        LEFT JOIN ext.StudentEnrollment               ON ext.StudentBase.studentuniqueidentifier =                  ext.StudentEnrollment.studentuniqueidentifier WHERE  (           (              ext.StudentEnrollment.entrydate IN (                SELECT Max(entrydate)                FROM ext.StudentEnrollment SE                WHERE ext.StudentEnrollment.studentuniqueidentifier = SE.studentuniqueidentifier              )            )          AND ( ( ext.AddressContact.addresstypecode ) = 'primary1'                 OR ( ext.AddressContact.addresstypecode ) IS NULL )          AND ( ( ext.StudentEnrollment.enrollmentstatus ) = 'a' ) )          and ext.StudentBase.schoolCode='010';"},
				{schemaName:'Student_Enrollment', query:"SELECT  ext.StudentEnrollment.* FROM   (ext.StudentBase         LEFT JOIN ext.AddressContact                ON ext.StudentBase.studentuniqueidentifier =                   ext.AddressContact.studentuniqueidentifier)        LEFT JOIN ext.StudentEnrollment               ON ext.StudentBase.studentuniqueidentifier =                  ext.StudentEnrollment.studentuniqueidentifier WHERE  (           (              ext.StudentEnrollment.entrydate IN (                SELECT Max(entrydate)                FROM ext.StudentEnrollment SE                WHERE ext.StudentEnrollment.studentuniqueidentifier = SE.studentuniqueidentifier              )            )          AND ( ( ext.AddressContact.addresstypecode ) = 'primary1'                 OR ( ext.AddressContact.addresstypecode ) IS NULL )          AND ( ( ext.StudentEnrollment.enrollmentstatus ) = 'a' ) )          and ext.StudentBase.schoolCode='010';"},
		...
		"assembler": {
			"expressbook": { //captured by dictionary.js, and instance of the named assembler is created with the params which are specific to that assembler
				name: 'mergeArrays', //'pseudoSql', //note: this refers to an assembler in the dataAccess module package. Could refer to a fully qualified path to an assembler elsewhere.
				params: {
