...
var moduleFunction = function(args) {
	...
	this.stashFlatUNUSED=function(data, fileWriteCallback){
	...
	this.getTabStringUNUSED=function(){
	...
	this.getObject=function(){
		var outObj={},
			tmpList=self.dataBuffer.split(self.lineEnding);
		outObj.fieldList=tmpList[0].split('\t');
		tmpList.remove(0);
		outObj.data=tmpList;
		return outObj;
	}
